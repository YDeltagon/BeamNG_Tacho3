angular.module('beamng.apps')
  .directive('enhancedForcedInductionV2', ['$log', 'Utils', ($log, Utils) => {
    return {
      template:
        '<object style="width:100%; height:100%; opacity: 0; box-sizing:border-box; box-shadow: none; border: none; point-event: none" type="image/svg+xml" data="/ui/modules/apps/enhancedForcedInductionV2/app.svg"></object>',
      replace: true,
      restrict: 'EA',
